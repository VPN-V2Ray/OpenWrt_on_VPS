...
#	Dscription: OpenWrt_on_VPS Deployment
#	Version: 1.0
#	Install: Run: `bash -c "$(wget -O- https://git.io/vpsopenwrt)"`
#====================================================
clear
echo "
   ____  ____       _____
...
wget --no-check-certificate https://raw.githubusercontent.com/VPN-V2Ray/OpenWrt_on_VPS/main/$wrt_kernel
